...
agent:  agent
model: GPT-5.2-Codex
name: APITestGenerator.md
description: This prompt is used to generate API tests for MyBasket microservices using Playwright API flows.
tools: [vscode/askQuestions, execute, read, agent, edit, search, web, 'accessibility-mcp/*', todo] 
---
